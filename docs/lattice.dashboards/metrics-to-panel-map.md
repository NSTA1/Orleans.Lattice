...
| `orleans.lattice.materialiser.pin.reports_shed` | counter | `tree`, `tenant` | CommitPath | Steady-state pin reports dropped to protect a pin store that is not keeping up (issue #2014) |
