...
| `orleans.lattice.shard_root.scan_page.zero_progress_stalls` | counter | `tree`, `shard`, `outcome` | CommitPath | Shard-root wedge guards (forward timeouts, scan-page stalls, scan resumptions, and flush suspensions) |
