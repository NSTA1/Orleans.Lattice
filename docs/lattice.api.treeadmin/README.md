...
- The remaining whole-tree lifecycle operations (bulk-load, resize, reshard, and the rest) land in later releases, each delegating to (or composing) the appropriate single-responsibility facade rather than re-implementing it here.
