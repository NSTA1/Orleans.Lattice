...
> Measured 2026-08-24 on Standard_D4as_v5 (.NET 10.0.111) at git sha 36bc5b08, n=3 cohorts (BDN quick).
...
> Measured 2026-08-24 on Standard_D4as_v5 in westus3 (.NET 10.0.111) at git sha 36bc5b08, n=1/3 cohorts. Read workloads were driven at 4000 vehicles / 5 Hz / 45s; each write workload was driven at a reduced per-row offered load (annotated in its operation label) to hold the single Azure Tables account below saturation.
