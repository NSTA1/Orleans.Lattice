...
/// Api.Auth authorization fixtures: it resolves the ambient credential's
...
/// test assemblies).
/// </summary>
public sealed class AuthApiTestCredentialAuthenticator : ILatticeCredentialAuthenticator
{
    ...
    public const string Issuer = "https://issuer.api-auth.test/";
