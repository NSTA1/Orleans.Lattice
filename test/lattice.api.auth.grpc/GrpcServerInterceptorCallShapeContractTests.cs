...
/// <summary>
/// Guards the <c>Orleans.Lattice.Api.Auth.Grpc</c> package against a server-side gRPC interceptor that
...
{
    /// <inheritdoc />
    protected override Assembly PackageAssembly => typeof(LatticeAuthApiGrpcAuthInterceptor).Assembly;
}