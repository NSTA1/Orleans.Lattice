...
/// </remarks>
public class OidcAlgorithmPinSeamGuardTests
{
    [Test]
    public void No_oidc_authenticator_overrides_the_method_that_applies_the_pin()
    {
        var subclasses = typeof(OidcCredentialAuthenticator).Assembly
            .GetTypes()
    ...
    /// </summary>
    [Test]
    public void Oidc_authenticator_requires_an_algorithm_pin()
    {
        ...
        options.Audiences.Add("lattice-audience");

        var authenticator = new OidcCredentialAuthenticator(options);
