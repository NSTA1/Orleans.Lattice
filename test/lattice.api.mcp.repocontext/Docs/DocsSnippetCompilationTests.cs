...
/// <summary>
/// Compiles this package's own <c>docs/lattice.api.mcp.repocontext</c> <c>`csharp verify</c> snippets
...
public sealed class DocsSnippetCompilationTests : DocsSnippetCompilationTestsBase
{
    ...
    protected override DocsSnippetScope Scope { get; } =
        DocsSnippetScope.ForPackage("docs/lattice.api.mcp.repocontext");
}
