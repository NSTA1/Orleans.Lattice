...
namespace Orleans.Lattice.Replication.Grpc.Tests.Docs;

/// <summary>
/// Compiles this package's own <c>docs/lattice.replication.grpc</c> <c>`csharp verify</c> snippets
...
public sealed class DocsSnippetCompilationTests : DocsSnippetCompilationTestsBase
{
    ...
    protected override DocsSnippetScope Scope { get; } =
        DocsSnippetScope.ForPackage("docs/lattice.replication.grpc");
}
