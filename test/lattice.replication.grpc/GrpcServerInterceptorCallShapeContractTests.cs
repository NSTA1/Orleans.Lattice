...
/// <summary>
/// Guards the <c>Orleans.Lattice.Replication.Grpc</c> package against a server-side gRPC interceptor that
...
{
    /// <inheritdoc />
    protected override Assembly PackageAssembly => typeof(LatticeReplicationGrpcAuthInterceptor).Assembly;
}