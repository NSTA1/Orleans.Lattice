...
namespace Orleans.Lattice.Tenancy.Tests.Docs;

/// <summary>
/// Compiles this package's own <c>docs/lattice.tenancy</c> <c>`csharp verify</c> snippets
...
public sealed class DocsSnippetCompilationTests : DocsSnippetCompilationTestsBase
{
    ...
    protected override DocsSnippetScope Scope { get; } =
        DocsSnippetScope.ForPackage("docs/lattice.tenancy");
}
