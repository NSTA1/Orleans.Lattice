...
/// <summary>
/// Guards the single-namespace contract for the Azure Blob caching package:
/// every public type in <c>Orleans.Lattice.Caching.AzureBlob</c> must live in
/// that exact root namespace so the whole public surface sits behind a single
/// <c>using Orleans.Lattice.Caching.AzureBlob;</c>.
/// </summary>
[TestFixture]
