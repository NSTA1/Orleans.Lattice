...
/// <summary>
/// Guards the <c>Orleans.Lattice.Api.Schema.Grpc</c> package against a server-side gRPC interceptor that
...
{
    /// <inheritdoc />
    protected override Assembly PackageAssembly => typeof(LatticeSchemaApiGrpcAuthInterceptor).Assembly;
}