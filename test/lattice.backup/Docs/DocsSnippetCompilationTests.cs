...
namespace Orleans.Lattice.Backup.Tests.Docs;

/// <summary>
/// Compiles this package's own <c>docs/lattice.backup</c> <c>`csharp verify</c> snippets
...
public sealed class DocsSnippetCompilationTests : DocsSnippetCompilationTestsBase
{
    ...
    protected override DocsSnippetScope Scope { get; } =
        DocsSnippetScope.ForPackage("docs/lattice.backup");
}
