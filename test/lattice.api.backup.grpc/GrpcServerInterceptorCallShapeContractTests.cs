...
/// <summary>
/// Guards the <c>Orleans.Lattice.Api.Backup.Grpc</c> package against a server-side gRPC interceptor that
...
{
    /// <inheritdoc />
    protected override Assembly PackageAssembly => typeof(LatticeBackupApiGrpcAuthInterceptor).Assembly;
}