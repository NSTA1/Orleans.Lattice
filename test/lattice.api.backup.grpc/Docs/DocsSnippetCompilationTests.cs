...
namespace Orleans.Lattice.Api.Backup.Grpc.Tests.Docs;

/// <summary>
/// Compiles this package's own <c>docs/lattice.api.backup.grpc</c> <c>`csharp verify</c> snippets
...
public sealed class DocsSnippetCompilationTests : DocsSnippetCompilationTestsBase
{
    ...
    protected override DocsSnippetScope Scope { get; } =
        DocsSnippetScope.ForPackage("docs/lattice.api.backup.grpc");
}
