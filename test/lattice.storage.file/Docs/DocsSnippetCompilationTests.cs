...
namespace Orleans.Lattice.Storage.File.Tests.Docs;

/// <summary>
/// Compiles this package's own <c>docs/lattice.storage.file</c> <c>`csharp verify</c> snippets
...
public sealed class DocsSnippetCompilationTests : DocsSnippetCompilationTestsBase
{
    ...
    protected override DocsSnippetScope Scope { get; } =
        DocsSnippetScope.ForPackage("docs/lattice.storage.file");
}
