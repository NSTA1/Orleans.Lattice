...
namespace Orleans.Lattice.Storage.AzureTable.Tests.Docs;

/// <summary>
/// Compiles this package's own <c>docs/lattice.storage.azuretable</c> <c>`csharp verify</c> snippets
...
public sealed class DocsSnippetCompilationTests : DocsSnippetCompilationTestsBase
{
    ...
    protected override DocsSnippetScope Scope { get; } =
        DocsSnippetScope.ForPackage("docs/lattice.storage.azuretable");
}
