...
/// <para>
/// This project's current integration coverage drives Azure Table Storage
/// directly via the Azure SDK rather than an Orleans cluster, so the
/// detection signals below currently match nothing - the gate exists as a
/// guard against future contributors adding an in-process silo fixture
/// here without remembering to tag it.
/// </para>
/// <para>
