...
namespace Orleans.Lattice.Api.Data.Tests.Docs;

/// <summary>
/// Compiles this package's own <c>docs/lattice.api.data</c> <c>`csharp verify</c> snippets
...
public sealed class DocsSnippetCompilationTests : DocsSnippetCompilationTestsBase
{
    ...
    protected override DocsSnippetScope Scope { get; } =
        DocsSnippetScope.ForPackage("docs/lattice.api.data");
}
