...
/// Api.Data authorization fixtures: it resolves the ambient credential's
...
/// test assemblies).
/// </summary>
public sealed class ApiDataTestCredentialAuthenticator : ILatticeCredentialAuthenticator
{
    ...
    public const string Issuer = "https://issuer.api-data.test/";
