...
namespace Orleans.Lattice.Api.Telemetry.Tests.Docs;

/// <summary>
/// Compiles this package's own <c>docs/lattice.api.telemetry</c> <c>`csharp verify</c> snippets
...
public sealed class DocsSnippetCompilationTests : DocsSnippetCompilationTestsBase
{
    ...
    protected override DocsSnippetScope Scope { get; } =
        DocsSnippetScope.ForPackage("docs/lattice.api.telemetry");
}