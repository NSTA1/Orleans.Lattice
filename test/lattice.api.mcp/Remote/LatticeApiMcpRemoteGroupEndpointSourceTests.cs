...
public sealed class LatticeApiMcpRemoteGroupEndpointSourceTests
{
    ...
    public void EndpointFor_projects_each_configured_group()
    {
        var source = new LatticeApiMcpRemoteGroupEndpointSource(RemoteTestSupport.Options(o =>
        {
            ...
            o.TenantAdmin = new LatticeApiMcpRemoteEndpoint { Endpoint = "https://tenant:5007" };
        }));
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(source.EndpointFor(LatticeApiMcpGroup.TenantAdmin), Is.EqualTo("https://tenant:5007"));
        });
    }
    ...
    public void EndpointFor_unconfigured_group_is_null()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(source.EndpointFor(LatticeApiMcpGroup.TenantAdmin), Is.Null);
        });
    }
}
