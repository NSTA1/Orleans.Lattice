...
/// gRPC data-API authorization fixture: it resolves the ambient credential's
...
/// test assemblies).
/// </summary>
public sealed class ApiDataGrpcTestCredentialAuthenticator : ILatticeCredentialAuthenticator
{
    ...
    public const string Issuer = "https://issuer.api-data-grpc.test/";
