...
/// <summary>
/// Concrete guard for the <c>Orleans.Lattice.Replication</c> assembly: every
...
public sealed class SerializableExceptionDeepCopyContractTests : SerializableExceptionDeepCopyContractTestsBase
{
    ...
    /// <inheritdoc />
    protected override Assembly PackageAssembly => typeof(LatticeReplicationPreconditionFailedException).Assembly;
