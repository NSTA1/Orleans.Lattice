...
namespace Orleans.Lattice.GrainIndex.Tests.Docs;

/// <summary>
/// Compiles this package's own <c>docs/lattice.grainindex</c> <c>`csharp verify</c>
...
/// the package's docs scope so the snippets are verified whenever this package's
...
public sealed class DocsSnippetCompilationTests : DocsSnippetCompilationTestsBase
{
    ...
    protected override DocsSnippetScope Scope { get; } =
        DocsSnippetScope.ForPackage("docs/lattice.grainindex");
}
