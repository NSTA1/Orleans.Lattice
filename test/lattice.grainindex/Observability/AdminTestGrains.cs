...
/// <summary>
/// The state the observability integration tests project. It carries Orleans
/// serialization attributes because a real silo persists it through the memory
/// grain-storage provider.
/// </summary>
[GenerateSerializer]
public sealed class AdminUserState
{
...
/// <summary>
/// The dormant population the observability tests onboard. Its state parameter
/// carries <see cref="IndexedAttribute"/>, so it indexes itself the moment it
/// activates - which is exactly what the crawl relies on, and what the
/// activation-path counter observes.
/// </summary>
public interface IAdminUserGrain : IGrainWithStringKey
{
...
/// <summary>The grain the observability integration tests index.</summary>
public sealed class AdminUserGrain(
    [Indexed("admin-user")] IPersistentState<AdminUserState> state) : Grain, IAdminUserGrain
{
    /// <inheritdoc />
