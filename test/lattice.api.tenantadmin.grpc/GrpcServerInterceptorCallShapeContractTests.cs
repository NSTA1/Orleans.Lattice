...
/// <summary>
/// Guards the <c>Orleans.Lattice.Api.TenantAdmin.Grpc</c> package against a server-side gRPC interceptor that
...
{
    /// <inheritdoc />
    protected override Assembly PackageAssembly => typeof(LatticeTenantAdminApiGrpcAuthInterceptor).Assembly;
}