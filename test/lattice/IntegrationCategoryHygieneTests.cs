...
public class IntegrationCategoryHygieneTests
{
    ...
    /// slow-category tags. The failure message lists every offending
    /// fixture's <see cref="Type.FullName"/> and the categories it already
    /// carries so the fix is mechanical.
    /// </summary>
    [Test]
