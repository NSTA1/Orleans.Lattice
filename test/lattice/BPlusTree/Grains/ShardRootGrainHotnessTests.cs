...
public class ShardRootGrainHotnessTests
{
        ...
        string shardKey = "test-tree/0")
    {
        ...
        return new ShardRootGrain(context, state, grainFactory, optionsResolver, Microsoft.Extensions.Logging.Abstractions.NullLogger<ShardRootGrain>.Instance, TestMutationObservers.NoObservers());
    }
