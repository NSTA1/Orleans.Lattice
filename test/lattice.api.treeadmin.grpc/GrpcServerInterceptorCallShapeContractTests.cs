...
/// <summary>
/// Guards the <c>Orleans.Lattice.Api.TreeAdmin.Grpc</c> package against a server-side gRPC interceptor that
...
{
    /// <inheritdoc />
    protected override Assembly PackageAssembly => typeof(LatticeTreeAdminApiGrpcAuthInterceptor).Assembly;
}