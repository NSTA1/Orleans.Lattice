...
/// gRPC state-API authorization fixture: it resolves the ambient credential's
...
/// test assemblies).
/// </summary>
public sealed class ApiStateGrpcTestCredentialAuthenticator : ILatticeCredentialAuthenticator
{
    ...
    public const string Issuer = "https://issuer.api-state-grpc.test/";
