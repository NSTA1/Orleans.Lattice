...
| `SetManyAtomicAsync` (64 keys/saga) | **0.188** (16 keys/saga) | 64,653 | **~5.3 k** sagas/s ≈ **~85 k** keys/s | **268** keys/s ≈ **4.2** sagas/s (sustained), **768** keys/s burst max³ ⁵ | **~1,476**⁴            | **~3,330**⁴            |
