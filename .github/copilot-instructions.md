...
| Replication public API namespace | `Orleans.Lattice.Replication` | `LatticeReplicationOptions`, `IReplicationTransport`, `LatticeReplicationServiceCollectionExtensions`, `ReplogEntry`, `ReplogOp` |
