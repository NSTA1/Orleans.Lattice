...
| Replication public API namespace | `Orleans.Lattice.Replication` | `LatticeReplicationOptions`, `IReplicationTransport`, `ReplicationBatch`, `ReplicationAck`, `IChangeFeed`, `IReplicationApplier`, `ApplyResult`, `LatticeReplicationServiceCollectionExtensions`, `ReplogEntry`, `ReplogOp`, `ReplicationMode`, `IReplicationModeResolver`, `LatticeReplicationMetrics`, `ReplicationPeerStats`, `ReplicationPeerSnapshot`, `LwwRegisterDelta`, `OrSetDelta`, `OrSetDot`, `PnCounterDelta`, `VersionVectorDelta`, `IWalStorageProvider`, `InMemoryWalStorageProvider`, `WalEntry` |
