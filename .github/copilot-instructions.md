...
|---|---|---|
| Public API namespace | `Orleans.Lattice` | `ILattice`, `LatticeOptions`, `SnapshotMode`, `LatticeExtensions`, `IMutationObserver`, `LatticeMutation`, `MutationKind`, `MutationCategory`, `LatticeOriginContext`, `LatticeVectorClockContext`, `LatticeHlcOverrideContext`, `LatticeAtomicBatchContext`, `CrdtLatticeExtensions`, `OrSetAccessor`, `PnCounterAccessor`, `VersionVectorAccessor`, `MvRegisterAccessor`, `LeafProjectionDigest`, `ProjectionRebuildPolicy`, `LeafProjectionStaleException`, `IWalStorageProvider`, `InMemoryWalStorageProvider`, `IWalMutationEncoder`, `OrleansBinaryWalMutationEncoder`, `WalEntry`, `WalRecord`, `IWalCursorRegistry`, `InMemoryWalCursorRegistry`, `WalCursorSnapshot`, `ILatticeWalGc`, `LatticeWalGc`, `LatticeWalGcReport`, `LatticeMergeMode`, `ILatticeMergeModeResolver`, `ILatticeOriginClusterIdResolver`, `LatticeIdempotencyKey`, `LatticeIdempotencyContext`, `ILatticeRetryPolicy`, `BoundedExponentialRetryPolicy`, `BoundedExponentialRetryPolicyOptions`, `LatticeServiceCollectionExtensions`, `LatticeSnapshotCoordinate`, `LatticeSnapshotExpiredException`, `LatticeSnapshotReplayBudgetExceededException`, `LatticeScopedCursor` |
...
| Replication public API namespace | `Orleans.Lattice.Replication` | `LocalVcSeedReport`, `ILatticeReplicationSecretSource`, `LatticeReplicationAcceptedSecrets`, `LatticeReplicationSecurityOptions`, `LatticeReplicationEnvironmentVariables`, `LatticeReplicationSharedSecret`, `EnvironmentVariableSecretSource`, `ConfigurationBindingSecretSource`, `LatticeReplicationSecurityServiceCollectionExtensions`, `IRemoteSnapshotTransport`, `RemoteSnapshotMetadata`, `RemoteSnapshotMetadataRequest`, `RemoteSnapshotStreamItem`, `LatticeRemoteSnapshotService`, `IBootstrapSnapshotSource`, `LocalBootstrapSnapshotSource`, `RemoteSnapshotProvider`, `BootstrapCoordinatorStatus`, `IReplicationTopology`, `PeerChanged`, `PeerChangeKind`, `LatticeReplicationHealthCheckOptions`, `IReceiverFlowControlPolicy`, `ReceiverFlowControlContext`, `ReceiverFlowControlHint`, `NoOpReceiverFlowControlPolicy` |
