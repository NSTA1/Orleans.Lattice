...
| Replication public API namespace | `Orleans.Lattice.Replication` | `LatticeReplicationOptions`, `IReplicationTransport`, `LatticeReplicationServiceCollectionExtensions`, `ReplogEntry`, `ReplogOp`, `LatticeReplicationMetrics`, `ReplicationPeerStats`, `ReplicationPeerSnapshot` |
