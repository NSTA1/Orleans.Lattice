...
| Replication public API namespace | `Orleans.Lattice.Replication` | `LatticeReplicationOptions`, `IReplicationTransport`, `IChangeFeed`, `IReplicationApplier`, `ApplyResult`, `LatticeReplicationServiceCollectionExtensions`, `ReplogEntry`, `ReplogOp`, `LatticeReplicationMetrics`, `ReplicationPeerStats`, `ReplicationPeerSnapshot`, `LwwRegisterDelta`, `OrSetDelta`, `OrSetDot`, `PnCounterDelta`, `VersionVectorDelta` |
