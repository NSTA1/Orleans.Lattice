...
if (string.Equals(suite, "statetrims", StringComparison.OrdinalIgnoreCase))
{
    Console.WriteLine("[microbench] suite   -> statetrims (StateApiAllocationTrimBenchmarks)");
    var stateTrimsSummary = BenchmarkRunner.Run<StateApiAllocationTrimBenchmarks>(config);
    return stateTrimsSummary.HasCriticalValidationErrors ? 1 : 0;
}

if (string.Equals(suite, "stateorder", StringComparison.OrdinalIgnoreCase))
{
    Console.WriteLine("[microbench] suite   -> stateorder (CatalogSelectionTrimBenchmarks, ShardSummaryOrderingBenchmarks)");
    var catalogSelectionSummary = BenchmarkRunner.Run<CatalogSelectionTrimBenchmarks>(config);
    var shardOrderingSummary = BenchmarkRunner.Run<ShardSummaryOrderingBenchmarks>(config);
    return catalogSelectionSummary.HasCriticalValidationErrors || shardOrderingSummary.HasCriticalValidationErrors
        ? 1
        : 0;
}
...
if (string.Equals(suite, "terminalpendingtrim", StringComparison.OrdinalIgnoreCase))
{
    Console.WriteLine("[microbench] suite   -> terminalpendingtrim (TerminalFanOutAndPendingReadTrimBenchmarks)");
    var terminalPendingSummary = BenchmarkRunner.Run<TerminalFanOutAndPendingReadTrimBenchmarks>(config);
    return terminalPendingSummary.HasCriticalValidationErrors ? 1 : 0;
}
...
if (string.Equals(suite, "reshardfolds", StringComparison.OrdinalIgnoreCase))
{
...
if (string.Equals(suite, "fanoutslots", StringComparison.OrdinalIgnoreCase))
{
...
if (string.Equals(suite, "replicationapplytrims", StringComparison.OrdinalIgnoreCase))
{
    Console.WriteLine("[microbench] suite   -> replicationapplytrims (ReplicationApplyBatchTrimBenchmarks)");
    var replicationApplyTrimsSummary = BenchmarkRunner.Run<ReplicationApplyBatchTrimBenchmarks>(config);
    return replicationApplyTrimsSummary.HasCriticalValidationErrors ? 1 : 0;
}

if (string.Equals(suite, "authcompiletrims", StringComparison.OrdinalIgnoreCase))
{
...
if (string.Equals(suite, "grainindexquerytrims", StringComparison.OrdinalIgnoreCase))
{
    Console.WriteLine("[microbench] suite   -> grainindexquerytrims (GrainIndexQueryTrimBenchmarks)");
    var grainIndexQueryTrimsSummary = BenchmarkRunner.Run<GrainIndexQueryTrimBenchmarks>(config);
    return grainIndexQueryTrimsSummary.HasCriticalValidationErrors ? 1 : 0;
}

if (string.Equals(suite, "grainindexplanfolds", StringComparison.OrdinalIgnoreCase))
{
...
if (string.Equals(suite, "crdtrunfolds", StringComparison.OrdinalIgnoreCase))
{
    Console.WriteLine("[microbench] suite   -> crdtrunfolds (CrdtDeltaRunFoldBenchmarks)");
    var crdtRunFoldsSummary = BenchmarkRunner.Run<CrdtDeltaRunFoldBenchmarks>(config);
    return crdtRunFoldsSummary.HasCriticalValidationErrors ? 1 : 0;
}

if (string.Equals(suite, "coalescedefertrims", StringComparison.OrdinalIgnoreCase))
{
    Console.WriteLine("[microbench] suite   -> coalescedefertrims (CoalesceDeferAndDnfTrimBenchmarks)");
    var coalesceDeferTrimsSummary = BenchmarkRunner.Run<CoalesceDeferAndDnfTrimBenchmarks>(config);
    return coalesceDeferTrimsSummary.HasCriticalValidationErrors ? 1 : 0;
}
...
if (string.Equals(suite, "applygatetrims", StringComparison.OrdinalIgnoreCase))
{
    Console.WriteLine("[microbench] suite   -> applygatetrims (ApplyGatePinTagTrimBenchmarks)");
    var applyGateSummary = BenchmarkRunner.Run<ApplyGatePinTagTrimBenchmarks>(config);
    return applyGateSummary.HasCriticalValidationErrors ? 1 : 0;
}

if (string.Equals(suite, "alloctrio", StringComparison.OrdinalIgnoreCase))
{
...
{
    Console.WriteLine("[microbench] suite   -> tagrowtrims (TagRowParseAndShardGatherBenchmarks)");
    var tagRowSummary = BenchmarkRunner.Run<TagRowParseAndShardGatherBenchmarks>(config);
    return tagRowSummary.HasCriticalValidationErrors ? 1 : 0;
}

if (string.Equals(suite, "tagindexbatching", StringComparison.OrdinalIgnoreCase))
{
...
if (string.Equals(suite, "fanoutcollapse", StringComparison.OrdinalIgnoreCase))
{
    Console.WriteLine("[microbench] suite   -> fanoutcollapse (FanOutCollapseBenchmarks)");
    var fanOutCollapseSummary = BenchmarkRunner.Run<FanOutCollapseBenchmarks>(config);
    return fanOutCollapseSummary.HasCriticalValidationErrors ? 1 : 0;
}

if (string.Equals(suite, "roundtripwaves", StringComparison.OrdinalIgnoreCase))
{
