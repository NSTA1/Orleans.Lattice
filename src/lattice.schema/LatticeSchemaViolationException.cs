...
/// <summary>
/// Same-silo deep-copier for <see cref="LatticeSchemaViolationException"/>. Orleans deep-copies a grain result
...
/// </summary>
[RegisterCopier]
internal sealed class LatticeSchemaViolationExceptionCopier : IDeepCopier<LatticeSchemaViolationException>
{
    /// <inheritdoc />
    public LatticeSchemaViolationException DeepCopy(LatticeSchemaViolationException input, CopyContext context) => input;
}
