...
/// Orleans serializer, so every auth-API wire message rides the same versioned,
...
/// stream's <see cref="IBufferWriter{T}"/> without an intermediate array.
/// </summary>
internal static class LatticeAuthApiGrpcMarshallers
{
    /// <summary>
