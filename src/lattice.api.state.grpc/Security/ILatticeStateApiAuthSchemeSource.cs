...
/// <summary>
/// Supplies the auth-scheme advertisement the state-API endpoint returns from
/// its unauthenticated <c>GetAuthScheme</c> RPC. A host registers an
/// implementation (or configures the built-in options-backed one) to tell
...
/// </remarks>
public interface ILatticeStateApiAuthSchemeSource
{
    /// <summary>
