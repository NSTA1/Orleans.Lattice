...
/// <summary>
/// Default <see cref="ILatticeStateApiCredentialBridge"/> that lifts a single
/// configurable request header into a <see cref="LatticeCredential"/>. Reads the
/// header named by <see cref="LatticeStateApiGrpcOptions.CredentialHeaderName"/>
/// (default <c>authorization</c>), strips a leading
/// <see cref="LatticeStateApiGrpcOptions.CredentialScheme"/> prefix (default
...
/// auth-backed visibility fails closed.
/// </remarks>
internal sealed class HeaderLatticeStateApiCredentialBridge : ILatticeStateApiCredentialBridge
{
    ...
    /// </summary>
    public HeaderLatticeStateApiCredentialBridge(IOptions<LatticeStateApiGrpcOptions> options)
    {
