...
/// <summary>
/// One authentication scheme the state-API endpoint advertises to a connecting
/// client: a stable id the client matches to a login provider, a friendly
/// display name, and the public parameters the provider needs to run the
/// challenge (for example an Entra authority, tenant, client id, and audience).
/// </summary>
/// <remarks>
...
/// </remarks>
[GenerateSerializer]
[Alias(GrpcStateTypeAliases.AuthSchemeDescriptor)]
[Immutable]
