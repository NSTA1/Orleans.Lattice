...
/// are filed under, the scope name for the independent sub-capability the
/// access-model probe reports, and the declared preference key its retained
...
public static class AccessPluginKeys
{
    ...
    /// is ignored without one, which is the ordinary case for this area: Access
    ...
    /// </remarks>
    public const string SurfaceParameter = "access-surface";
    ...
    public static readonly ExplorerPreferenceKey SurfacePreference = new(
        "access.surface",
        "the Access surface you were last on");
}
