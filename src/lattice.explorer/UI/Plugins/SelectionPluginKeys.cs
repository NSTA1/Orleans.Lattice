...
/// constants exist because two places name an id - the plugin's own descriptor
/// and the retained-preference seeding a view performs when it navigates - and
/// a literal in either would drift.
/// </para>
/// </summary>
