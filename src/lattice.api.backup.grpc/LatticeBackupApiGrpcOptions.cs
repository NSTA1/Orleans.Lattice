...
/// <summary>
/// Options controlling the <c>Orleans.Lattice.Api.Backup.Grpc</c> server-side
/// binding.
/// </summary>
public sealed class LatticeBackupApiGrpcOptions
{
    /// <summary>
    /// Whether the authorization interceptor enforces
    /// <see cref="ILatticeBackupApiAuthorizer"/> on every inbound backup
