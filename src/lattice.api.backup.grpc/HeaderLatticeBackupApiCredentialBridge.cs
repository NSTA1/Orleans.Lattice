...
/// <summary>
/// Default <see cref="ILatticeBackupApiCredentialBridge"/> that lifts a single
/// configurable request header into a <see cref="LatticeCredential"/>. Reads the
/// header named by <see cref="LatticeBackupApiGrpcOptions.CredentialHeaderName"/>
/// (default <c>authorization</c>), strips a leading
/// <see cref="LatticeBackupApiGrpcOptions.CredentialScheme"/> prefix (default
...
/// auth-backed backup control fails closed.
/// </remarks>
internal sealed class HeaderLatticeBackupApiCredentialBridge : ILatticeBackupApiCredentialBridge
{
    ...
    /// </summary>
    public HeaderLatticeBackupApiCredentialBridge(IOptions<LatticeBackupApiGrpcOptions> options)
    {
