...
public interface ILatticeCredentialAuthenticator
{
    ...
    /// is invalid or expired. Only called after <see cref="CanHandle"/> returned
    /// <c>true</c>. A <c>null</c> result resolves the caller to
    /// <see cref="LatticeSubject.Anonymous"/> - never to a stale authorized
    /// subject.
    /// </summary>
