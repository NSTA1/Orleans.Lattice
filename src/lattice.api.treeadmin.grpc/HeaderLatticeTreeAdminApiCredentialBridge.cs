...
/// <summary>
/// Default <see cref="ILatticeTreeAdminApiCredentialBridge"/> that lifts a single
/// configurable request header into a <see cref="LatticeCredential"/>. Reads the
/// header named by
/// <see cref="LatticeTreeAdminApiGrpcOptions.CredentialHeaderName"/> (default
/// <c>authorization</c>), strips a leading
/// <see cref="LatticeTreeAdminApiGrpcOptions.CredentialScheme"/> prefix (default
...
/// auth-backed control fails closed.
/// </remarks>
internal sealed class HeaderLatticeTreeAdminApiCredentialBridge : ILatticeTreeAdminApiCredentialBridge
{
    ...
    /// </summary>
    public HeaderLatticeTreeAdminApiCredentialBridge(IOptions<LatticeTreeAdminApiGrpcOptions> options)
    {
