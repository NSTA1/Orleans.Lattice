...
public static class GrpcTreeAdminTypeAliases
{
    ...
    /// <summary>Alias for <see cref="TreeAdminOrphanedLeafRequest"/>.</summary>
    public const string TreeAdminOrphanedLeafRequest = "oitg.orphreq";
    ...
    /// <summary>Alias for <see cref="TreeAdminWalMovePlanRequest"/>.</summary>
    public const string TreeAdminWalMovePlanRequest = "oitg.wplanreq";

    /// <summary>Alias for <see cref="TreeAdminWalMoveExecuteRequest"/>.</summary>
    public const string TreeAdminWalMoveExecuteRequest = "oitg.wmovereq";
    ...
    /// <summary>Alias for <see cref="TreeAdminCreateViewRequest"/>.</summary>
    public const string TreeAdminCreateViewRequest = "oitg.vwcreq";

    /// <summary>Alias for <see cref="TreeAdminTagIndexRequest"/>.</summary>
    public const string TreeAdminTagIndexRequest = "oitg.tgreq";

    /// <summary>Alias for <see cref="TreeAdminTagIndexListRequest"/>.</summary>
    public const string TreeAdminTagIndexListRequest = "oitg.tglreq";
