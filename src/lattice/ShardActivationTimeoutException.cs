...
/// <summary>
/// Same-silo deep-copier for <see cref="ShardActivationTimeoutException"/>. Orleans deep-copies a grain result
...
/// </summary>
[RegisterCopier]
internal sealed class ShardActivationTimeoutExceptionCopier : IDeepCopier<ShardActivationTimeoutException>
{
    /// <inheritdoc />
    public ShardActivationTimeoutException DeepCopy(ShardActivationTimeoutException input, CopyContext context) => input;
}
