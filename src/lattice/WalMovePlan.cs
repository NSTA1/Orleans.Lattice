...
/// </summary>
[GenerateSerializer]
[Alias(TypeAliases.WalMovePlan)]
[Immutable]
public readonly record struct WalMovePlan
{
    ...
    /// <summary>
    /// <see langword="true"/> when the placement pin already maps the partition
    /// to <see cref="ToProviderKey"/>. Executing the move is then an idempotent
    /// no-copy repair.
    /// </summary>
