...
/// <summary>
/// Same-silo deep-copier for <see cref="LatticeAuthorizationDeniedException"/>. Orleans deep-copies a grain result
...
/// </summary>
[RegisterCopier]
internal sealed class LatticeAuthorizationDeniedExceptionCopier : IDeepCopier<LatticeAuthorizationDeniedException>
{
    /// <inheritdoc />
    public LatticeAuthorizationDeniedException DeepCopy(LatticeAuthorizationDeniedException input, CopyContext context) => input;
}
