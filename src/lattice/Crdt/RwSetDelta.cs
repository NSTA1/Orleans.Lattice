...
public readonly record struct RwSetDelta
{
    ...
    /// <summary>
    /// Compares two deltas by value, with <see cref="Adds"/>,
    /// <see cref="Removes"/>, and <see cref="Tombstones"/> compared
    /// element-by-element using the value equality of
    /// <see cref="OrSetDeltaDot"/>. The compiler-generated record-struct
    /// equality compares the collection references with
