...
/// <summary>
/// Same-silo deep-copier for <see cref="LatticeShuttingDownException"/>. Orleans deep-copies a grain result
...
/// </summary>
[RegisterCopier]
internal sealed class LatticeShuttingDownExceptionCopier : IDeepCopier<LatticeShuttingDownException>
{
    /// <inheritdoc />
    public LatticeShuttingDownException DeepCopy(LatticeShuttingDownException input, CopyContext context) => input;
}
