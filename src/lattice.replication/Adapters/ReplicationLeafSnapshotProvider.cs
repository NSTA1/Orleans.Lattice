...
/// Wraps the existing <see cref="ISnapshotProvider"/> with a leaf-key
/// range filter so a consumer can drain a single leaf''s key range
...
/// </para>
/// </summary>
internal sealed class ReplicationLeafSnapshotProvider(
