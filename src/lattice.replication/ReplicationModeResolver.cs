...
/// <summary>
/// Default <see cref="IReplicationModeResolver"/> implementation backed by
...
/// </summary>
internal sealed class ReplicationModeResolver : IReplicationModeResolver, IDisposable
{
    private readonly IOptionsMonitor<LatticeReplicationOptions> _options;
    private readonly ConcurrentDictionary<string, ReplicationMode?> _cache = new(StringComparer.Ordinal);
    private readonly Func<string, ReplicationMode?> _factory;
    private readonly IDisposable? _changeSubscription;

    public ReplicationModeResolver(IOptionsMonitor<LatticeReplicationOptions> options)
    {
