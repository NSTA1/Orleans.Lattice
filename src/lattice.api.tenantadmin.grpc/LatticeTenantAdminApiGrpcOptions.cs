...
/// <summary>
/// Options controlling the <c>Orleans.Lattice.Api.TenantAdmin.Grpc</c>
/// server-side binding.
/// </summary>
public sealed class LatticeTenantAdminApiGrpcOptions
{
    /// <summary>
    /// Whether the authorization interceptor enforces
    /// <see cref="ILatticeTenantAdminApiAuthorizer"/> on every inbound
    /// tenant-administration control-API call. Defaults to <see langword="true"/>
