...
/// <summary>
/// Default <see cref="ILatticeTenantAdminApiCredentialBridge"/> that lifts a
/// single configurable request header into a <see cref="LatticeCredential"/>.
/// Reads the header named by
/// <see cref="LatticeTenantAdminApiGrpcOptions.CredentialHeaderName"/> (default
/// <c>authorization</c>), strips a leading
/// <see cref="LatticeTenantAdminApiGrpcOptions.CredentialScheme"/> prefix (default
...
/// </remarks>
internal sealed class HeaderLatticeTenantAdminApiCredentialBridge : ILatticeTenantAdminApiCredentialBridge
{
    ...
    /// </summary>
    public HeaderLatticeTenantAdminApiCredentialBridge(IOptions<LatticeTenantAdminApiGrpcOptions> options)
    {
