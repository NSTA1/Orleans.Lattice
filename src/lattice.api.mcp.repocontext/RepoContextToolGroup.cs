        ...
        => McpServerTool.Create(
            ...
            new McpServerToolCreateOptions
            {
                ...
                Description =
                    ...
                    + "vector search), 'keyword.no_embedder' (no embedding provider is bound - an intended "
        ...
        => McpServerTool.Create(
            ...
            new McpServerToolCreateOptions
            {
                ...
                Description =
                    ...
                    + "'semantic.approximate', 'keyword.no_embedder', 'keyword.vector_plane_unavailable', or "
