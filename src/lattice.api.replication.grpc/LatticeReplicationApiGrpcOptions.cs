...
/// <summary>
/// Options controlling the <c>Orleans.Lattice.Api.Replication.Grpc</c>
/// server-side binding.
/// </summary>
public sealed class LatticeReplicationApiGrpcOptions
{
    /// <summary>
    /// Whether the authorization interceptor enforces
    /// <see cref="ILatticeReplicationApiAuthorizer"/> on every inbound
    /// replication control-API call. Defaults to <see langword="true"/>
