...
/// <summary>
/// Supplies the auth-scheme advertisement the replication control-API endpoint
/// returns from its unauthenticated <c>GetAuthScheme</c> RPC. A host registers
/// an implementation (or configures the built-in options-backed one) to tell
/// connecting clients how to sign in - which schemes are accepted and the public
/// parameters (OIDC authority, tenant, client id, audience) each needs.
/// </summary>
/// <remarks>
...
/// </remarks>
public interface ILatticeReplicationApiAuthSchemeSource
{
    /// <summary>
