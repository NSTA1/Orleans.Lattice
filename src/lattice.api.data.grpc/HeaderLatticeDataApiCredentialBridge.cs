...
/// <summary>
/// Default <see cref="ILatticeDataApiCredentialBridge"/> that lifts a single
/// configurable request header into a <see cref="LatticeCredential"/>. Reads the
/// header named by <see cref="LatticeDataApiGrpcOptions.CredentialHeaderName"/>
/// (default <c>authorization</c>), strips a leading
/// <see cref="LatticeDataApiGrpcOptions.CredentialScheme"/> prefix (default
...
/// the access gate fails closed on every mutation and read.
/// </remarks>
internal sealed class HeaderLatticeDataApiCredentialBridge : ILatticeDataApiCredentialBridge
{
    ...
    /// </summary>
    public HeaderLatticeDataApiCredentialBridge(IOptions<LatticeDataApiGrpcOptions> options)
    {
