...
/// <summary>
/// Default <see cref="ILatticeSchemaApiCredentialBridge"/> that lifts a single
/// configurable request header into a <see cref="LatticeCredential"/>. Reads the
/// header named by <see cref="LatticeSchemaApiGrpcOptions.CredentialHeaderName"/>
/// (default <c>authorization</c>), strips a leading
/// <see cref="LatticeSchemaApiGrpcOptions.CredentialScheme"/> prefix (default
...
/// auth-backed schema control fails closed.
/// </remarks>
internal sealed class HeaderLatticeSchemaApiCredentialBridge : ILatticeSchemaApiCredentialBridge
{
    ...
    /// </summary>
    public HeaderLatticeSchemaApiCredentialBridge(IOptions<LatticeSchemaApiGrpcOptions> options)
    {
