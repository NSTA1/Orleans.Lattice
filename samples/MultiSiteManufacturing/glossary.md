...
| **IChangeFeed** | Package-side post-apply event stream over a tree. `BaselineReplicationReplay` subscribes with `includeLocalOrigin: false` to drive the divergence-visualisation backend. |
