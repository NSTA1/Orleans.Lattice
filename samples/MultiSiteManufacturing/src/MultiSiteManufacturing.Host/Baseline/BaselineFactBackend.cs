...
/// <see cref="MultiSiteManufacturing.Host.Replication.BaselineReplicationReplay"/>
/// for every replicated <c>mfg-facts</c> Set entry observed on the
/// package's <c>IChangeFeed</c>. This models naive event-log
/// replication for the baseline backend so a peer's baseline view
/// matches the seeding cluster on cold start. Deletes are not
/// replayed - the baseline is an append-only fold with no
/// retraction concept.
/// </para>
/// </remarks>
