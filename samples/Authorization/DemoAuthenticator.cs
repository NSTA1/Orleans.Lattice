...
namespace Orleans.Lattice.Samples.Authorization;
...
/// one silo with no identity provider. Group membership is not asserted here -
/// the membership directory expands each subject's groups (including nested
/// groups) from the user/group edges seeded at startup.
/// </summary>
internal sealed class DemoAuthenticator : ILatticeCredentialAuthenticator
{
    ...
    public const string Issuer = "https://issuer.authorization.sample/";
